...
export const managers = [
    {
      ...
      "favoriteTeam": "TEN, GB, MIN", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
    ...
    },
    {
      ...
      "tradingScale": 10, // 1 - 10
      "preferredContact": "No", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
    {
