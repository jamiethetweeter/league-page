/*   STEP 1   */
export const leagueID = "967072889914683392"; // your league ID
export const leagueName = "FLEG13"; // your league name
...
export const homepageText = `
  <p>Welcome to the new home of FLEG</p>
  <p>I SAID ARE YOU READYYYYYYY</p>
  <p></p>
  <p></p>
  <p></p>
  <p></p>
...
export const managers = [
    {
      ...
      "favoritePlayer": 21685, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
    ...
    },
    {
      ...
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Chiefs and rookie wideouts",
      "tradingScale": 10, // 1 - 10
    ...
    },
    {
      ...
      "philosophy": "Gotta be in it to win it!",
      "tradingScale": 10, // 1 - 10
    ...
    },
   {
      ...
      "favoritePlayer": 146, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "RB", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "ADP",
      "tradingScale": 5, // 1 - 10
    ...
    },
   {
      ...
      "bio": "I'm unlucky, feel sorry for me",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
      ...
      "favoritePlayer": 1926, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Your fantasy team's philosophy is to underperform",
      "tradingScale": 6, // 1 - 10
      "preferredContact": "Sleeper", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
   {
